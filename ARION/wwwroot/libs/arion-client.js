//const apiEndpoint = "https://localhost:5011/api/v1";
const apiEndpoint = "https://arionapimanagement.azure-api.net/api/v1";
...
window.addEventListener('load', function () {
    ...
    fetch(`${apiEndpoint}/TrackedPage?queryPageUrl=${encodeURIComponent(pageUrl)}`)
